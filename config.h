...
static const char *volume_lower[] = { "change-volume", "lower", NULL };
static const char *volume_mute[] = { "change-volume", "mute-toggle", NULL };

static const char *brightness_raise[] = { "change-brightness", "raise", NULL };
static const char *brightness_lower[] = { "change-brightness", "lower", NULL };

static const char *kbd_brightness_raise[] = { "change-kbd-brightness", "raise", NULL };
static const char *kbd_brightness_lower[] = { "change-kbd-brightness", "lower", NULL };
...
#define CHVT(n) { WLR_MODIFIER_CTRL|WLR_MODIFIER_ALT,XKB_KEY_XF86Switch_VT_##n, chvt, {.ui = (n)} }
  ...
  { 0,	XF86XK_AudioMute,               spawn,{.v = volume_mute } },
	{ 0,	XF86XK_MonBrightnessUp, 	      spawn,{.v = brightness_raise } },
  { 0,	XF86XK_MonBrightnessDown, 	    spawn,{.v = brightness_lower } },
	{ 0,	XF86XK_KbdBrightnessUp, 	      spawn,{.v = kbd_brightness_raise } },
  { 0,	XF86XK_KbdBrightnessDown, 	    spawn,{.v = kbd_brightness_lower } },
};
